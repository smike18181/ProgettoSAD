...
# Seleziona solo i tweet "Pro_Russia"
df_ucraina = df[df['classification'] == 'Pro-Russia'].copy()

if df_ucraina.empty:
    print("Nessun tweet trovato con classificazione 'Pro_Russia'.")
    exit()
...
optimal_clusters = 4  # numero scelto in base al grafico del gomito
