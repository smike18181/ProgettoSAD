...
# Seleziona solo i tweet "No War"
df_ucraina = df[df['classification'] == 'No War'].copy()

if df_ucraina.empty:
    print("Nessun tweet trovato con classificazione 'No War'.")
    exit()
...
optimal_clusters = 4  # scelto in base al grafico del gomito
